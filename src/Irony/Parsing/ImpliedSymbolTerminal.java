...
public class ImpliedSymbolTerminal extends Terminal {
  protected NObject javonetHandle;

  public ImpliedSymbolTerminal(java.lang.String name) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Irony.Parsing.ImpliedSymbolTerminal", name);
  ...
  public ImpliedSymbolTerminal(NObject handle) {
    super(handle);
