...
public class CustomActionHint extends GrammarHint {
  protected NObject javonetHandle;

  public CustomActionHint(ExecuteActionMethod executeMethod, PreviewActionMethod previewMethod) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Irony.Parsing.CustomActionHint", executeMethod, previewMethod);
  ...
  public CustomActionHint(NObject handle) {
    super(handle);
