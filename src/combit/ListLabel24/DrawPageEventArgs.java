...
public class DrawPageEventArgs extends EventArgs implements IDisposable {
  protected NObject javonetHandle;
  /** GetProperty */
  public LlPage getCallbackData() {
    try {
      Object res = javonetHandle.<NObject>get("CallbackData");
      if (res == null) return null;
      return new LlPage((NObject) res);
  ...
  public DrawPageEventArgs(LlPage callbackData, java.lang.Boolean scale) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.DrawPageEventArgs", callbackData, scale);
  ...
  public DrawPageEventArgs(NObject handle) {
    super(handle);
