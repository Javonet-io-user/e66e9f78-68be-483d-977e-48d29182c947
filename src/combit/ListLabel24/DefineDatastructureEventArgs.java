...
public class DefineDatastructureEventArgs extends EventArgs {
  ...
  public LlCore getLlCore() {
    try {
      Object res = javonetHandle.<NObject>get("LlCore");
      if (res == null) return null;
  ...
  public DefineDatastructureEventArgs(NObject handle) {
    super(handle);
