...
public class AutoDefineElementEventArgs extends EventArgs {
  ...
  public void setFieldType(LlFieldType value) {
    try {
      javonetHandle.set("FieldType", NEnum.fromJavaEnum(value));
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public LlFieldType getFieldType() {
    try {
      Object res = javonetHandle.<NEnum>get("FieldType");
      if (res == null) return null;
  ...
  public ITableRow getAssociatedTableRow() {
    try {
      Object res = javonetHandle.<NObject>get("AssociatedTableRow");
      if (res == null) return null;
      return ConvertToConcreteInterfaceImplementation(res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public AutoDefineElementEventArgs(
    ...
    try {
      javonetHandle =
          Javonet.New(
              "combit.ListLabel24.AutoDefineElementEventArgs",
              isDesignMode,
              name,
              value,
              progressPercent,
  ...
  public AutoDefineElementEventArgs(NObject handle) {
    super(handle);
