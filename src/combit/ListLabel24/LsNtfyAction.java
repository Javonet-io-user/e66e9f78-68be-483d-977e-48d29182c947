...
public class LsNtfyAction extends ValueType {
  ...
  public java.lang.Integer getParameterList() {
    try {
      java.lang.Integer res = javonetHandle.get("ParameterList");
      if (res == null) return 0;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public void setParameterList(java.lang.Integer param) {
    try {
      javonetHandle.set("ParameterList", param);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public LsNtfyAction(NObject handle) {
    super(handle);
