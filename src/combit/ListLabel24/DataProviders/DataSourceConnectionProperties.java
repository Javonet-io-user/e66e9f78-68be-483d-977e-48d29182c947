...
public class DataSourceConnectionProperties {
  ...
  public void setSourceType(DataSourceType value) {
    try {
  ...
  public DataSourceType getSourceType() {
    try {
      ...
      return DataSourceType.valueOf(((NEnum) res).getValueName());
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public DataSourceConnectionProperties() {
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel24.DataProviders.DataSourceConnectionProperties");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public DataSourceConnectionProperties(NObject handle) {
