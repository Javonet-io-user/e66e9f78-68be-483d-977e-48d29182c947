...
public class DataSource extends Component
    implements IComponent, IDisposable, IDataProvider, IListSource, ICanHandleUsedIdentifiers {
  protected NObject javonetHandle;
  /** SetProperty */
  public void setConnectionProperties(DataSourceConnectionProperties value) {
    try {
      javonetHandle.set("ConnectionProperties", value);
  ...
  public DataSourceConnectionProperties getConnectionProperties() {
    try {
      Object res = javonetHandle.<NObject>get("ConnectionProperties");
      if (res == null) return null;
      return new DataSourceConnectionProperties((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public DataSource(IContainer container) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.DataProviders.DataSource", container);
  ...
  public DataSource(NObject handle) {
    super(handle);
