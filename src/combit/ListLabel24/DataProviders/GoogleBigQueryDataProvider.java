...
public class GoogleBigQueryDataProvider implements IDataProvider {
  ...
  public java.lang.String getProjectId() {
    try {
      java.lang.String res = javonetHandle.get("ProjectId");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public GoogleBigQueryDataProvider(
    ...
    try {
      javonetHandle =
          Javonet.New(
              "combit.ListLabel24.DataProviders.GoogleBigQueryDataProvider",
              projectId,
              refreshToken,
              clientId,
              clientSecret);
  ...
  public GoogleBigQueryDataProvider(NObject handle) {
  ...
  public void AddQuery(java.lang.String tableName, java.lang.String query) {
    try {
      javonetHandle.invoke("AddQuery", tableName, query);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
