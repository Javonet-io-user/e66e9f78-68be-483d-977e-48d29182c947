...
public class GroupByNode extends SqlNodeBase implements IAstNodeInit {
  protected NObject javonetHandle;

  public GroupByNode() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.DataProviders.SqlTokenizer.GroupByNode");
  ...
  public GroupByNode(NObject handle) {
    super(handle);
