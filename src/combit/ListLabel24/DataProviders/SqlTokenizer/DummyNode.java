...
public class DummyNode implements IAstNodeInit {
  protected NObject javonetHandle;

  public DummyNode() {
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.DataProviders.SqlTokenizer.DummyNode");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public DummyNode(NObject handle) {
