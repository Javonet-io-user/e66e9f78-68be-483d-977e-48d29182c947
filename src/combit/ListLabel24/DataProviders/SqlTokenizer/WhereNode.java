...
public class WhereNode extends SqlNodeBase implements IAstNodeInit {
  protected NObject javonetHandle;

  public WhereNode() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.DataProviders.SqlTokenizer.WhereNode");
  ...
  public WhereNode(NObject handle) {
    super(handle);
