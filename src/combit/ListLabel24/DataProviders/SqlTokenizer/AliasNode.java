...
public class AliasNode extends SqlNodeBase implements IAstNodeInit {
  ...
  public AliasNode() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.DataProviders.SqlTokenizer.AliasNode");
  ...
  public AliasNode(NObject handle) {
    super(handle);
