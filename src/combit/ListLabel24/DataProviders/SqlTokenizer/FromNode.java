...
public class FromNode extends SqlNodeBase implements IAstNodeInit {
  protected NObject javonetHandle;

  public FromNode() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.DataProviders.SqlTokenizer.FromNode");
  ...
  public FromNode(NObject handle) {
    super(handle);
