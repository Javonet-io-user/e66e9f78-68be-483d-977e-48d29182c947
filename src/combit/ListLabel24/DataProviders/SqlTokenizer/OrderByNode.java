...
public class OrderByNode extends SqlNodeBase implements IAstNodeInit {
  protected NObject javonetHandle;

  public OrderByNode() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.DataProviders.SqlTokenizer.OrderByNode");
  ...
  public OrderByNode(NObject handle) {
    super(handle);
