...
public class HavingNode extends SqlNodeBase implements IAstNodeInit {
  protected NObject javonetHandle;

  public HavingNode() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.DataProviders.SqlTokenizer.HavingNode");
  ...
  public HavingNode(NObject handle) {
    super(handle);
