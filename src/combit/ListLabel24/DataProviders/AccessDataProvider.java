...
public class AccessDataProvider extends OleDbConnectionDataProvider
  ...
  public AccessDataProvider(java.lang.String fileName) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.DataProviders.AccessDataProvider", fileName);
  ...
  public AccessDataProvider(java.lang.String fileName, java.lang.String password) {
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel24.DataProviders.AccessDataProvider", fileName, password);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
