...
public class LlPage extends ValueType {
  ...
  public java.lang.Boolean getbDesignerPreview() {
    try {
      java.lang.Boolean res = javonetHandle.get("bDesignerPreview");
  ...
  public void setbDesignerPreview(java.lang.Boolean param) {
    try {
      javonetHandle.set("bDesignerPreview", param);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.Boolean getbPreDraw() {
    try {
      java.lang.Boolean res = javonetHandle.get("bPreDraw");
      if (res == null) return false;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public void setbPreDraw(java.lang.Boolean param) {
    try {
      javonetHandle.set("bPreDraw", param);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
