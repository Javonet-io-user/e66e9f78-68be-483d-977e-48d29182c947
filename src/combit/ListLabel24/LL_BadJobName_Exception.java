...
public class LL_BadJobName_Exception extends ListLabelException
  ...
  public LL_BadJobName_Exception() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.LL_BadJobName_Exception");
  ...
  public LL_BadJobName_Exception(java.lang.String message) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.LL_BadJobName_Exception", message);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public LL_BadJobName_Exception(java.lang.String message, jio.System.Exception innerException) {
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel24.LL_BadJobName_Exception", message, innerException);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
