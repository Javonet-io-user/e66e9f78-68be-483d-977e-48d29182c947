...
public class PreviewFileEnumerator implements IEnumerator, Iterator<Object> {
  ...
  public PreviewPage getCurrentProperty() {
    try {
  ...
  public PreviewFileEnumerator(NObject handle) {
