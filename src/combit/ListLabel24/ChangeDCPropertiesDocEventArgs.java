...
public class ChangeDCPropertiesDocEventArgs extends EventArgs {
  ...
  public ChangeDCPropertiesDocEventArgs(LlPrinter callbackData) {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel24.ChangeDCPropertiesDocEventArgs", callbackData);
  ...
  public ChangeDCPropertiesDocEventArgs(NObject handle) {
    super(handle);
