...
public class ViewerButtonClickedEventArgs extends EventArgs {
  ...
  public ViewerButtonClickedEventArgs(java.lang.Integer id, IWin32Window viewerWindow) {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel24.ViewerButtonClickedEventArgs", id, viewerWindow);
  ...
  public ViewerButtonClickedEventArgs(NObject handle) {
    super(handle);
