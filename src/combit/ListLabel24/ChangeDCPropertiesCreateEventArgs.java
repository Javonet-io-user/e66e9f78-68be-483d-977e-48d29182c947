...
public class ChangeDCPropertiesCreateEventArgs extends EventArgs {
  ...
  public ChangeDCPropertiesCreateEventArgs(LlPrinter callbackData) {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel24.ChangeDCPropertiesCreateEventArgs", callbackData);
  ...
  public ChangeDCPropertiesCreateEventArgs(NObject handle) {
    super(handle);
