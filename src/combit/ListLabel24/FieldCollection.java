...
public class FieldCollection extends ElementBaseCollection
  ...
  public FieldCollection(ListLabel ll) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.FieldCollection", ll);
  ...
  public FieldCollection(NObject handle) {
    super(handle);
