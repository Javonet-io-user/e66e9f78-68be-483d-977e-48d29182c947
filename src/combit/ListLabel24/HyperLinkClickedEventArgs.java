...
public class HyperLinkClickedEventArgs extends EventArgs implements IDisposable {
  protected NObject javonetHandle;
  /** GetProperty */
  public LlHyperlinkAction getAction() {
    try {
      Object res = javonetHandle.<NEnum>get("Action");
      if (res == null) return null;
      return LlHyperlinkAction.valueOf(((NEnum) res).getValueName());
  ...
  public HyperLinkClickedEventArgs(LlHyperLinkClicked callbackData) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.HyperLinkClickedEventArgs", callbackData);
  ...
  public HyperLinkClickedEventArgs(NObject handle) {
    super(handle);
