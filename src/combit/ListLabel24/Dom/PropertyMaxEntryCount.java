...
public class PropertyMaxEntryCount extends DomItem {
  protected NObject javonetHandle;
  /** SetProperty */
  public void setMaxEntries(java.lang.String value) {
    try {
      javonetHandle.set("MaxEntries", value);
  ...
  public java.lang.String getMaxEntries() {
    try {
      java.lang.String res = javonetHandle.get("MaxEntries");
      if (res == null) return "";
  ...
  public void setWithOthers(java.lang.String value) {
    try {
      javonetHandle.set("WithOthers", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getWithOthers() {
    try {
      java.lang.String res = javonetHandle.get("WithOthers");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public PropertyMaxEntryCount(NObject handle) {
    super(handle);
