...
public class ObjectLine extends ObjectBase {
  ...
  public void setLineDirection(java.lang.String value) {
    try {
      javonetHandle.set("LineDirection", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getLineDirection() {
    try {
      java.lang.String res = javonetHandle.get("LineDirection");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public void setLineType(java.lang.String value) {
    try {
      javonetHandle.set("LineType", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getLineType() {
    try {
      java.lang.String res = javonetHandle.get("LineType");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public ObjectLine(CollectionObjectBases objectCollection) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.ObjectLine", objectCollection);
  ...
  public ObjectLine(CollectionObjectBases objectCollection, java.lang.Integer index) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.ObjectLine", objectCollection, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public ObjectLine(NObject handle) {
    super(handle);
