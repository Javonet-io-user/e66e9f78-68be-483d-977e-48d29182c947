...
public class PropertyInputButtonActionSendTo extends PropertyInputButtonActionBase {
  ...
  public void setShowDialog(java.lang.String value) {
    try {
  ...
  public java.lang.String getShowDialog() {
    try {
      java.lang.String res = javonetHandle.get("ShowDialog");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public PropertyInputButtonActionSendTo(PropertyInputButtonActionBase item) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.PropertyInputButtonActionSendTo", item);
  ...
  public PropertyInputButtonActionSendTo(NObject handle) {
    super(handle);
