...
public class PropertyAlphaBlendableItem extends DomItem {
  protected NObject javonetHandle;
  /** SetProperty */
  public void setAlpha(java.lang.String value) {
    try {
      javonetHandle.set("Alpha", value);
  ...
  public java.lang.String getAlpha() {
    try {
      java.lang.String res = javonetHandle.get("Alpha");
      if (res == null) return "";
  ...
  public PropertyAlphaBlendableItem(NObject handle) {
    super(handle);
