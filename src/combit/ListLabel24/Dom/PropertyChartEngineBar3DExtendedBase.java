...
public abstract class PropertyChartEngineBar3DExtendedBase extends PropertyChartEngineBar3DBase {
  ...
  public PropertyChartEngineBar3DExtendedBase(NObject handle) {
    super(handle);
