...
public class PropertyReservedSpace extends DomItem {
  ...
  public java.lang.String getRight() {
    try {
      java.lang.String res = javonetHandle.get("Right");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.String getBottom() {
    try {
      java.lang.String res = javonetHandle.get("Bottom");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public PropertyReservedSpace(NObject handle) {
    super(handle);
  ...
  public void Set(
    ...
    try {
      javonetHandle.invoke("Set", left, top, right, bottom);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
