...
public abstract class PropertyShapeItemBase extends DomItem {
  ...
  public PropertyShapeBackground getBackground() {
    try {
      Object res = javonetHandle.<NObject>get("Background");
      if (res == null) return null;
      return new PropertyShapeBackground((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public PropertyShapeItemBase(NObject handle) {
    super(handle);
