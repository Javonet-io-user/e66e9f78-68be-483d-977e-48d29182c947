...
public class PropertyLegendItem extends DomItem {
  ...
  public PropertyLegendItem(CollectionManualLegend collectionManualLegend) {
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel24.Dom.PropertyLegendItem", collectionManualLegend);
  ...
  public PropertyLegendItem(
      CollectionManualLegend collectionManualLegend, java.lang.Integer index) {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel24.Dom.PropertyLegendItem", collectionManualLegend, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public PropertyLegendItem(NObject handle) {
    super(handle);
