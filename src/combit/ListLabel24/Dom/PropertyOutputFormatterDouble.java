...
public class PropertyOutputFormatterDouble extends PropertyOutputFormatterBase {
  ...
  public void setExponentialFormat(java.lang.String value) {
    try {
      javonetHandle.set("ExponentialFormat", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getExponentialFormat() {
    try {
      java.lang.String res = javonetHandle.get("ExponentialFormat");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public void setRemoveTrailingZeroes(java.lang.String value) {
    try {
      javonetHandle.set("RemoveTrailingZeroes", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getRemoveTrailingZeroes() {
    try {
      java.lang.String res = javonetHandle.get("RemoveTrailingZeroes");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public PropertyOutputFormatterDouble(PropertyOutputFormatterBase item) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.PropertyOutputFormatterDouble", item);
  ...
  public PropertyOutputFormatterDouble(NObject handle) {
    super(handle);
