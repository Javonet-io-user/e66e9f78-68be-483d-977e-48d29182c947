...
public class ObjectChart extends ObjectBase {
  ...
  public ObjectChart(LlChartType chartType, CollectionObjectBases objectCollection) {
    ...
    try {
      javonetHandle =
          Javonet.New(
              "combit.ListLabel24.Dom.ObjectChart",
  ...
  public ObjectChart(
      LlChartType chartType, CollectionObjectBases itemCollection, java.lang.Integer index) {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New(
  ...
  public ObjectChart(NObject handle) {
    super(handle);
