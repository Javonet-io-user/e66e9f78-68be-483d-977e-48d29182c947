...
public class TableInputFieldComboBox extends TableInputFieldBase {
  protected NObject javonetHandle;
  /** SetProperty */
  public void setEditable(java.lang.String value) {
    try {
      javonetHandle.set("Editable", value);
  ...
  public java.lang.String getEditable() {
    try {
      java.lang.String res = javonetHandle.get("Editable");
      if (res == null) return "";
  ...
  public void setChoices(java.lang.String value) {
    try {
  ...
  public java.lang.String getChoices() {
    try {
      java.lang.String res = javonetHandle.get("Choices");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public TableInputFieldComboBox(CollectionTableFieldBases itemCollection) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.TableInputFieldComboBox", itemCollection);
  ...
  public TableInputFieldComboBox(
      CollectionTableFieldBases itemCollection, java.lang.Integer index) {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel24.Dom.TableInputFieldComboBox", itemCollection, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public TableInputFieldComboBox(NObject handle) {
    super(handle);
