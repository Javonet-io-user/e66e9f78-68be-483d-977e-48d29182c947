...
public class PropertyCheckboxDefinition extends DomItem {
  ...
  public PropertyCheckboxDesign getDesign() {
    try {
      Object res = javonetHandle.<NObject>get("Design");
      if (res == null) return null;
      return new PropertyCheckboxDesign((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public PropertyCheckboxDefinition(DomItem item) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.PropertyCheckboxDefinition", item);
  ...
  public PropertyCheckboxDefinition(NObject handle) {
    super(handle);
