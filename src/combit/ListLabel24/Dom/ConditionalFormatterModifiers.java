...
public class ConditionalFormatterModifiers extends DomItem {
  ...
  public ConditionalFormatterModifiers(DomItem item) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.ConditionalFormatterModifiers", item);
  ...
  public ConditionalFormatterModifiers(NObject handle) {
    super(handle);
