...
public class PropertyChartLabelCoordinateOnObjectPie extends DomItem {
  ...
  public void setPlacement(java.lang.String value) {
    try {
      javonetHandle.set("Placement", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getPlacement() {
    try {
      java.lang.String res = javonetHandle.get("Placement");
      if (res == null) return "";
  ...
  public PropertyChartLabelCoordinateOnObjectPie(NObject handle) {
    super(handle);
