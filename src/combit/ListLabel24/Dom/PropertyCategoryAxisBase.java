...
public abstract class PropertyCategoryAxisBase extends DomItem {
  ...
  public void setRoundLimits(java.lang.String value) {
    try {
  ...
  public java.lang.String getRoundLimits() {
    try {
  ...
  public PropertyCategoryAxisBase(NObject handle) {
    super(handle);
