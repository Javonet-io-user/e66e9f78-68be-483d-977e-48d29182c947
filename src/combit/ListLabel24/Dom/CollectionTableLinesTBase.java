...
public abstract class CollectionTableLinesTBase<T> extends CollectionTableLinesBase
  ...
  public T get_Item(java.lang.String itemName, Class<?> returnType) {
    try {
  ...
  public CollectionTableLinesTBase(NObject handle) {
    super(handle);
  ...
  public CollectionEnumerator<T> GetEnumerator() {
    try {
      ...
      if (res == null) return null;
      return new CollectionEnumerator<T>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
