...
public class PropertyChartEngineLineMultiRow extends PropertyChartEngineLineAreaBubbleBase {
  ...
  public PropertyChartEngineLineMultiRow(PropertyChartEngineBase item) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.PropertyChartEngineLineMultiRow", item);
  ...
  public PropertyChartEngineLineMultiRow(NObject handle) {
    super(handle);
