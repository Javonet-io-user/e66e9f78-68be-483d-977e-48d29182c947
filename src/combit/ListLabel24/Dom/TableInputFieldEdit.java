...
public class TableInputFieldEdit extends TableInputFieldBase {
  ...
  public void setDefaultValueText(java.lang.String value) {
    try {
      javonetHandle.set("DefaultValueText", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getDefaultValueText() {
    try {
      java.lang.String res = javonetHandle.get("DefaultValueText");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public TableInputFieldEdit(CollectionTableFieldBases itemCollection) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.TableInputFieldEdit", itemCollection);
  ...
  public TableInputFieldEdit(CollectionTableFieldBases itemCollection, java.lang.Integer index) {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel24.Dom.TableInputFieldEdit", itemCollection, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public TableInputFieldEdit(NObject handle) {
    super(handle);
