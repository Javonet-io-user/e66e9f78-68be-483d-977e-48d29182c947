...
public class PropertyChartArea extends DomItem {
  ...
  public PropertyInnerInterval getInnerInterval() {
    try {
      Object res = javonetHandle.<NObject>get("InnerInterval");
      if (res == null) return null;
      return new PropertyInnerInterval((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public PropertyChartArea(NObject handle) {
    super(handle);
