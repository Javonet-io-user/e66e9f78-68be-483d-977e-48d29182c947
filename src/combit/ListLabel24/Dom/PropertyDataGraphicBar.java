...
public class PropertyDataGraphicBar extends DomItem {
  ...
  public PropertyAlignment getAlignment() {
    try {
      Object res = javonetHandle.<NObject>get("Alignment");
      if (res == null) return null;
      return new PropertyAlignment((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public PropertyColorRanges getColorRanges() {
    try {
      Object res = javonetHandle.<NObject>get("ColorRanges");
      if (res == null) return null;
      return new PropertyColorRanges((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public PropertyDataGraphicBar(NObject handle) {
    super(handle);
