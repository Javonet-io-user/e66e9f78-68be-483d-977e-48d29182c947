...
public class PropertyLabels extends DomItem {
  ...
  public CollectionTextItems getList() {
    try {
      Object res = javonetHandle.<NObject>get("List");
      if (res == null) return null;
      return new CollectionTextItems((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public PropertyLabels(NObject handle) {
    super(handle);
