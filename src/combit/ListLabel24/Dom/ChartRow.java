...
public class ChartRow extends DomItem {
  ...
  public void setCoordinateLabel(java.lang.String value) {
    try {
      javonetHandle.set("CoordinateLabel", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getCoordinateLabel() {
    try {
      java.lang.String res = javonetHandle.get("CoordinateLabel");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public void setVisualSymbol(java.lang.String value) {
    try {
      javonetHandle.set("VisualSymbol", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getVisualSymbol() {
    try {
      java.lang.String res = javonetHandle.get("VisualSymbol");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public void setValueAxisAssignment(java.lang.String value) {
    try {
      javonetHandle.set("ValueAxisAssignment", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getValueAxisAssignment() {
    try {
      java.lang.String res = javonetHandle.get("ValueAxisAssignment");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public ChartRow(CollectionChartRows rowCollection) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.ChartRow", rowCollection);
  ...
  public ChartRow(CollectionChartRows rowCollection, java.lang.Integer index) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.ChartRow", rowCollection, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public ChartRow(NObject handle) {
    super(handle);
