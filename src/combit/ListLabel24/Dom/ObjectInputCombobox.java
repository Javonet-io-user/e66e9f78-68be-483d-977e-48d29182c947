...
public class ObjectInputCombobox extends ObjectInputBase {
  ...
  public ObjectInputCombobox(CollectionObjectBases objectCollection) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.ObjectInputCombobox", objectCollection);
  ...
  public ObjectInputCombobox(CollectionObjectBases objectCollection, java.lang.Integer index) {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel24.Dom.ObjectInputCombobox", objectCollection, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public ObjectInputCombobox(NObject handle) {
    super(handle);
