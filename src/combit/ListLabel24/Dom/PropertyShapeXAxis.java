...
public class PropertyShapeXAxis extends DomItem {
  ...
  public void setFilter(java.lang.Boolean value) {
    try {
  ...
  public java.lang.Boolean getFilter() {
    try {
      java.lang.Boolean res = javonetHandle.get("Filter");
  ...
  public void setShapeAttribute(java.lang.String value) {
    try {
      javonetHandle.set("ShapeAttribute", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getShapeAttribute() {
    try {
      java.lang.String res = javonetHandle.get("ShapeAttribute");
      if (res == null) return "";
  ...
  public PropertyShapeXAxis(NObject handle) {
    super(handle);
