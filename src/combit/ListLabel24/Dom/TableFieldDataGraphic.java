...
public class TableFieldDataGraphic extends TableFieldBase {
  ...
  public PropertyDataGraphicDefinition getDefinition() {
    try {
      Object res = javonetHandle.<NObject>get("Definition");
      if (res == null) return null;
      return new PropertyDataGraphicDefinition((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public TableFieldDataGraphic(CollectionTableFieldBases itemCollection) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.TableFieldDataGraphic", itemCollection);
  ...
  public TableFieldDataGraphic(CollectionTableFieldBases itemCollection, java.lang.Integer index) {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel24.Dom.TableFieldDataGraphic", itemCollection, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public TableFieldDataGraphic(NObject handle) {
    super(handle);
