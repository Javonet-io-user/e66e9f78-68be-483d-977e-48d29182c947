...
public class TableFieldHtml extends TableFieldBase {
  ...
  public void setFitToObject(java.lang.String value) {
    try {
      javonetHandle.set("FitToObject", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getFitToObject() {
    try {
      java.lang.String res = javonetHandle.get("FitToObject");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public TableFieldHtml(CollectionTableFieldBases itemCollection, java.lang.Integer index) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.TableFieldHtml", itemCollection, index);
  ...
  public TableFieldHtml(CollectionTableFieldBases itemCollection) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.TableFieldHtml", itemCollection);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public TableFieldHtml(NObject handle) {
    super(handle);
