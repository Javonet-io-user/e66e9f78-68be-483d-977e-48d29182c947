...
public class PropertyChartLabelCoordinate extends DomItem {
  ...
  public void setFixedFontSize(java.lang.String value) {
    try {
      javonetHandle.set("FixedFontSize", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getFixedFontSize() {
    try {
      java.lang.String res = javonetHandle.get("FixedFontSize");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public PropertyChartLabelCoordinate(NObject handle) {
    super(handle);
