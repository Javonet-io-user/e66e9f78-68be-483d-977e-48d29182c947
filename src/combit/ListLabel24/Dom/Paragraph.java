...
public class Paragraph extends DomItem {
  ...
  public PropertyParagraphWrapping getWrapping() {
    try {
      Object res = javonetHandle.<NObject>get("Wrapping");
      if (res == null) return null;
      return new PropertyParagraphWrapping((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public void setParagraphSpacing(java.lang.String value) {
    try {
      javonetHandle.set("ParagraphSpacing", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getParagraphSpacing() {
    try {
      java.lang.String res = javonetHandle.get("ParagraphSpacing");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public void setTabAlignment(java.lang.String value) {
    try {
      javonetHandle.set("TabAlignment", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getTabAlignment() {
    try {
      java.lang.String res = javonetHandle.get("TabAlignment");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public void setTabPosition(java.lang.String value) {
    try {
      javonetHandle.set("TabPosition", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getTabPosition() {
    try {
      java.lang.String res = javonetHandle.get("TabPosition");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public void setUnerasable(java.lang.String value) {
    try {
      javonetHandle.set("Unerasable", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getUnerasable() {
    try {
      java.lang.String res = javonetHandle.get("Unerasable");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public Paragraph(CollectionParagraphs paragraphCollection) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.Paragraph", paragraphCollection);
  ...
  public Paragraph(CollectionParagraphs paragraphCollection, java.lang.Integer index) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.Paragraph", paragraphCollection, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public Paragraph(NObject handle) {
    super(handle);
