...
public abstract class PropertyChartEnginePieDonutBase extends PropertyChartEngineBase {
  ...
  public PropertyCategoryAxisPie getXAxis() {
    try {
      Object res = javonetHandle.<NObject>get("XAxis");
      if (res == null) return null;
      return new PropertyCategoryAxisPie((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public PropertyChartEnginePieDonutBase(NObject handle) {
    super(handle);
