...
public class PropertyLabelCell extends DomItem {
  ...
  public void setMaxWidth(java.lang.String value) {
    try {
      javonetHandle.set("MaxWidth", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getMaxWidth() {
    try {
      java.lang.String res = javonetHandle.get("MaxWidth");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public void setIndentation(java.lang.String value) {
    try {
      javonetHandle.set("Indentation", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getIndentation() {
    try {
      java.lang.String res = javonetHandle.get("Indentation");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public PropertyLabelCell(NObject handle) {
    super(handle);
