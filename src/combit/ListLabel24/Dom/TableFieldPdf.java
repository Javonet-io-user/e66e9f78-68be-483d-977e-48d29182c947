...
public class TableFieldPdf extends TableFieldBase {
  protected NObject javonetHandle;
  /** GetProperty */
  public PropertyPdfDefinition getDefinition() {
    try {
      Object res = javonetHandle.<NObject>get("Definition");
      if (res == null) return null;
      return new PropertyPdfDefinition((NObject) res);
  ...
  public TableFieldPdf(CollectionTableFieldBases itemCollection) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.TableFieldPdf", itemCollection);
  ...
  public TableFieldPdf(CollectionTableFieldBases itemCollection, java.lang.Integer index) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel24.Dom.TableFieldPdf", itemCollection, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public TableFieldPdf(NObject handle) {
    super(handle);
