...
public class PropertyValueAxis extends PropertyValueAxisBase {
  ...
  public void setAggregateType(java.lang.String value) {
    try {
      javonetHandle.set("AggregateType", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getAggregateType() {
    try {
      java.lang.String res = javonetHandle.get("AggregateType");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public PropertyValueAxis(NObject handle) {
    super(handle);
