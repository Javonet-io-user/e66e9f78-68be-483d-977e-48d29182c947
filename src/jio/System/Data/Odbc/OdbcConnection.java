...
public class OdbcConnection extends DbConnection
  ...
  public OdbcConnection(java.lang.String connectionString) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("System.Data.Odbc.OdbcConnection", connectionString);
  ...
  public OdbcConnection() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("System.Data.Odbc.OdbcConnection");
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public OdbcConnection(NObject handle) {
    super(handle);
