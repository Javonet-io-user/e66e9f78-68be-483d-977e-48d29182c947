...
public class DesignerActionListCollection extends CollectionBase
  ...
  public DesignerActionListCollection() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("System.ComponentModel.Design.DesignerActionListCollection");
  ...
  public DesignerActionListCollection(DesignerActionList[] value) {
    ...
    try {
      javonetHandle =
          Javonet.New(
              "System.ComponentModel.Design.DesignerActionListCollection", new Object[] {value});
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public DesignerActionListCollection(NObject handle) {
    super(handle);
